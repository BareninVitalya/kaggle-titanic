...
# 5. Быстрый запуск основного пайплайна
python main.py
```

После запуска скрипт main.py:

- выводит в консоль CV лучшей модели;
- обучает модель на тренировочных данных;
- строит предсказания для тестовых данных;
- сохраняет `submission` в папку `output/submissions`.
